...
function MissingPieceDiagram() {
  ...
  return (
    <div
      ref={ref}
      className={`ts-diagram${isRevealed ? " ts-diagram--revealed" : ""}`}
      aria-label="HR screen, unknown, technical interview, and 16Signals real work evidence"
    >
      <div className="ts-diagram__path" aria-hidden="true">
        <span className="ts-diagram__node ts-diagram__node--hr">HR SCREEN</span>
        <span className="ts-diagram__connector ts-diagram__connector--first" />
        <span className="ts-diagram__node ts-diagram__node--unknown">UNKNOWN</span>
        <span className="ts-diagram__connector ts-diagram__connector--second" />
        <span className="ts-diagram__node ts-diagram__node--technical">TECHNICAL INTERVIEW</span>
      </div>

      <div className="ts-diagram__missing" aria-hidden="true">
        <span className="ts-diagram__down-arrow">↓</span>
        <span className="ts-diagram__node ts-diagram__node--signals">16SIGNALS</span>
        <span className="ts-diagram__node ts-diagram__node--evidence">REAL WORK EVIDENCE</span>
      </div>

      <div className="ts-diagram__tools">Across version control + related work tools</div>
    </div>
  );
}
